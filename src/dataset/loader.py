...
DATASETS = {
    ...
    "PVR" : EvalsDataset,
    "RAVEN" : EvalsDataset,
    "RAVEN_TEXT_MCQA" : EvalsDataset,
    "RAVEN_TEXT_OPQA" : EvalsDataset,
    "RAVEN_SYMBOLIC_MCQA" : EvalsDataset,
    "RAVEN_SYMBOLIC_OPQA" : EvalsDataset,
    "RAVEN_COMBINED" : CombinedEvalsDataset,
    "BENCH" : EvalsDataset,
    "ACRE" : EvalsDataset,
    "ACRE_TEXT" : EvalsDataset,
    "ACRE_SYMBOLIC" : EvalsDataset,
